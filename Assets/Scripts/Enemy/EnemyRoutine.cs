...
public class EnemyRoutine : MonoBehaviour
{
    ...
    [SerializeField] float sinValue_x = 0;      // Sin関数の値
    float deltaPosX;                             // X軸方向のずれ
    ...
    private void Update()
    {
        ...
        transform.position = new Vector3(position.x + sinValue_x + deltaPosX,
